        ...
        <div className={`${className} p-5 space-y-1`}>
            {role === 'ADMIN' &&(
                ...
                > 
                    ...
                    ><RiAccountBoxFill  className="col-start-1 h-5 w-5"/><p className="col-start-3">Profile</p></Link>
                </Button>
                </>
                ...
                > 
                    ...
                    ><FiSettings  className="col-start-1 h-5 w-5"/><p className="col-start-3">Settings</p></Link>
                </Button>
                </>
        </div>
     );
